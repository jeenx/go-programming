...
Building on the code from the previous example
	...
	with the IDENTIFIER “y”. The variable should be of the UNDERLYING TYPE of
	your custom TYPE “x”
eg:
	type hotdog int
	var x hotdog
	...
	2. in func main
		...
		b. now do this
			i. now use CONVERSION to convert the TYPE of the VALUE stored in
			“x” to the UNDERLYING TYPE
